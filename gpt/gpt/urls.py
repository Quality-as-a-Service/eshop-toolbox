...
from gpt.views import gpt_dashboard_view, gpt_upload_view, gpt_dataset_action_view, gpt_completition_download, gpt_manual_view
...
urlpatterns = [
    ...
    path('modules/gpt/dataset/action', gpt_dataset_action_view, name='gpt-dataset-action'),
